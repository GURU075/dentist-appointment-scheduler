...
const DentistNavbar = () => {
  ...
  return (
    <>
      <nav className="bg-red-600 bg-opacity-40 sticky top-0 z-40 text-sm">
        <div className="container mx-auto px-2 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              className="bg-white bg-opacity-80 text-red-300 px-3 py-1 rounded-md border border-red-300 text-sm"
